...
// import uploadFilesMiddleware from '@/api-lib/middlewares/upload';
import { storage } from '@/api-lib/middlewares/upload';
...
handler.patch(
  ...
  async (req, res) => {
    ...
    let profilePicture;
    if (req.files) {
      // const images = await db.collection(
      //   process.env.MONGO_IMG_BUCKET + '.files'
      // );
